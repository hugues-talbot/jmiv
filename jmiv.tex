...
\caption{Elastica computation along the iterations for different shapes. If radius is toos large, elastica may increase after a certain number of iterations. }
