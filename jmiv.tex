...
\begin{algorithm}[H]
 ...
 \While{ \It $<$ \MIt  }{ 	
	...
	\If{ \It is odd }{	 
 		...
 		$S^{(i)} \longleftarrow F_i + \overline{Z_i}$\;
...
\caption{We plot the ratio of pairwise terms among all $\binom{|Y|}{2}$ combinations. The highest ring has rougly half the number of pairwise terms  than the lowest ring.}
\end{figure}
